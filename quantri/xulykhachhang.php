	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<h4>Khách hàng</h4>
				<?php
				$sql_select_khachhang = mysqli_query($con,"SELECT * FROM tbl_khachhang,diachi,giaodich WHERE tbl_khachhang.MSKH=diachi.MSKH AND  tbl_khachhang.MSKH=giaodich.MSKH GROUP BY giaodich.SoDonDH ORDER BY tbl_khachhang.MSKH DESC"); 
				?> 
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a href="?quanly=xemgiaodich&khachhang=<?php echo $row_khachhang['SoDonDH'] ?>" class="xem">Xem giao dịch</a></td>
					</tr>
					 <?php
					} 
					?> 
